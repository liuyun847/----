...
class TestCalculateNetOutputForItem:
    ...
    def test_doubling_recipe_same_item(self, recipe_analyzer, doubling_recipe):
        ...
        输入1输出2，净产出应为1
        """
        net_output = recipe_analyzer.calculate_net_output_for_item(doubling_recipe, "a")
    ...
    def test_loss_recipe_same_item(self, recipe_analyzer, loss_recipe):
        ...
        输入2输出1，净产出应为-1
        """
        net_output = recipe_analyzer.calculate_net_output_for_item(loss_recipe, "a")
    ...
    def test_simple_recipe_output_item(self, recipe_analyzer, simple_recipe):
        ...
        输入5，输出3，净产出应为3
        """
        net_output = recipe_analyzer.calculate_net_output_for_item(simple_recipe, "产品")
    ...
    def test_simple_recipe_input_item(self, recipe_analyzer, simple_recipe):
        ...
        输入5，输出3，输入物品净产出应为-5
        """
        net_output = recipe_analyzer.calculate_net_output_for_item(simple_recipe, "原料")
    ...
    def test_catalyst_recipe_catalyst_item(self, recipe_analyzer, catalyst_recipe):
        ...
        催化剂a输入1输出1，净产出应为0
        """
        net_output = recipe_analyzer.calculate_net_output_for_item(catalyst_recipe, "a")
    ...
    def test_catalyst_recipe_input_item(self, recipe_analyzer, catalyst_recipe):
        ...
        原料b输入5，净产出应为-5
        """
        net_output = recipe_analyzer.calculate_net_output_for_item(catalyst_recipe, "b")
    ...
    def test_catalyst_recipe_output_item(self, recipe_analyzer, catalyst_recipe):
        ...
        产品c输出3，净产出应为3
        """
        net_output = recipe_analyzer.calculate_net_output_for_item(catalyst_recipe, "c")
    ...
    def test_nonexistent_item(self, recipe_analyzer, simple_recipe):
        ...
        应返回0
        """
        net_output = recipe_analyzer.calculate_net_output_for_item(simple_recipe, "不存在的物品")
