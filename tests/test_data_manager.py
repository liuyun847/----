...
class TestAddRecipe:
    ...
    def test_add_new_recipe(self, temp_dir, sample_recipe_data):
        ...
        manager.add_recipe(
            "新配方", "设备", sample_recipe_data["inputs"], sample_recipe_data["outputs"])
    ...
    def test_add_duplicate_recipe(self, temp_dir, sample_recipe_data):
        ...
        manager.add_recipe(
            "配方1", "设备", sample_recipe_data["inputs"], sample_recipe_data["outputs"])
...
class TestUpdateRecipe:
    ...
    def test_update_existing_recipe(self, temp_dir, sample_recipe_data):
        ...
        manager.update_recipe("配方1", "新设备", new_inputs,
                              sample_recipe_data["outputs"])
    ...
    def test_update_nonexistent_recipe(self, temp_dir, sample_recipe_data):
        ...
        with pytest.raises(KeyError):
            manager.update_recipe(
                "不存在的配方", "设备", sample_recipe_data["inputs"], sample_recipe_data["outputs"])
...
class TestSearchRecipesByItem:
    ...
    def test_search_in_inputs(self, temp_dir, sample_recipes):
        ...
        results = manager.search_recipes_by_item(
            "铁矿石", search_inputs=True, search_outputs=False)
    ...
    def test_search_in_outputs(self, temp_dir, sample_recipes):
        ...
        results = manager.search_recipes_by_item(
            "铁锭", search_inputs=False, search_outputs=True)
    ...
    def test_search_in_both(self, temp_dir, sample_recipes):
        ...
        results = manager.search_recipes_by_item(
            "铁锭", search_inputs=True, search_outputs=True)
    ...
    def test_search_multiple_matches(self, temp_dir, sample_recipes):
        ...
        results = manager.search_recipes_by_item(
            "煤炭", search_inputs=True, search_outputs=True)
...
class TestEdgeCases:
    ...
    def test_recipe_with_special_characters(self, temp_dir):
        ...
        manager.add_recipe(
            "特殊配方", special_recipe["device"], special_recipe["inputs"], special_recipe["outputs"])
    ...
    def test_recipe_with_multiple_inputs_outputs(self, temp_dir):
        ...
        manager.add_recipe(
            "多配方", multi_recipe["device"], multi_recipe["inputs"], multi_recipe["outputs"])
